--
-- File generated with SQLiteStudio v3.0.7 on Sat Jan 16 19:56:27 2016
--
...
CREATE TABLE web_site_map_item (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, web_site_map INTEGER REFERENCES web_site (id) NOT NULL, web_site_page INTEGER REFERENCES web_site (id) NOT NULL, name TEXT NOT NULL, priority INTEGER DEFAULT (0), parent INTEGER REFERENCES web_site_map_item (id));
...
CREATE TABLE web_site_page_widget (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, web_site_page INTEGER REFERENCES web_site (id) NOT NULL, web_widget INTEGER REFERENCES web_widget (id) NOT NULL, name TEXT NOT NULL UNIQUE, info TEXT, data_json TEXT);
INSERT INTO web_site_page_widget (id, web_site_page, web_widget, name, info, data_json) VALUES (1, 1, 1, 'stats_services', 'Stats: Services', '{"name":"Services", "value":"table.stats.1.value", "view":"lookuptable.5", "color":"primary"}');
INSERT INTO web_site_page_widget (id, web_site_page, web_widget, name, info, data_json) VALUES (2, 1, 1, 'stats_tables', 'Stats: Schema Tables', '{"name":"Products", "value":"table.stats.2.value", "view":"lookuptable.5", "color":"green"}');
INSERT INTO web_site_page_widget (id, web_site_page, web_widget, name, info, data_json) VALUES (3, 1, 1, 'stats_os', 'Stats: OSes', '{"name":"OSes", "value":"table.stats.4.value", "view":"lookuptable.5", "color":"red"}');
INSERT INTO web_site_page_widget (id, web_site_page, web_widget, name, info, data_json) VALUES (4, 1, 1, 'stats_hw', 'Stats: Hardware', '{"name":"Hardware", "value":"table.stats.3.value", "view":"lookuptable.5", "color":"yellow"}');
INSERT INTO web_site_page_widget (id, web_site_page, web_widget, name, info, data_json) VALUES (5, 1, 2, 'table_service', 'Table: Services', '{"rows":"rows.service", "fields":"fields.service"}');
...
INSERT INTO stats (id, name, value, sql) VALUES (2, 'Products', '4', 'SELECT COUNT(*) AS value FROM product');
...
-- Table: web_site
CREATE TABLE web_site (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name TEXT NOT NULL UNIQUE, default_web_site_map INTEGER);
INSERT INTO web_site (id, name, default_web_site_map) VALUES (1, 'OpsDB', 1);
