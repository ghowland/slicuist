--
-- File generated with SQLiteStudio v3.0.7 on Wed Jan 20 08:08:12 2016
--
...
INSERT INTO web_widget (id, name, path, info) VALUES (13, 'RPC: Table List', 'scripts/webui/html_content/rpc_table_list.html', NULL);
...
INSERT INTO web_site_page_widget (id, web_site_page, web_widget, name, info, data_json) VALUES (1, 1, 1, 'stats_services', 'Stats: Services', '{"name":"Services", "value":"__table.stats.1.value", "view":"lookuptable.5", "color":"primary"}');
INSERT INTO web_site_page_widget (id, web_site_page, web_widget, name, info, data_json) VALUES (2, 1, 1, 'stats_tables', 'Stats: Schema Tables', '{"name":"Products", "value":"__table.stats.2.value", "view":"lookuptable.5", "color":"green"}');
INSERT INTO web_site_page_widget (id, web_site_page, web_widget, name, info, data_json) VALUES (3, 1, 1, 'stats_os', 'Stats: OSes', '{"name":"OSes", "value":"__table.stats.4.value", "view":"lookuptable.5", "color":"red"}');
INSERT INTO web_site_page_widget (id, web_site_page, web_widget, name, info, data_json) VALUES (4, 1, 1, 'stats_hw', 'Stats: Hardware', '{"name":"Hardware", "value":"__table.stats.3.value", "view":"lookuptable.5", "color":"yellow"}');
INSERT INTO web_site_page_widget (id, web_site_page, web_widget, name, info, data_json) VALUES (5, 1, 2, 'table_service', 'Table: Services', '{"rows":"__rows.service", "fields":"__fields.service", "title":"Services"}');
INSERT INTO web_site_page_widget (id, web_site_page, web_widget, name, info, data_json) VALUES (6, 1, 2, 'table_os', 'Table: OSes', '{"rows":"__rows.os_instance", "fields":"__fields.os_instance", "title":"OSes"}');
INSERT INTO web_site_page_widget (id, web_site_page, web_widget, name, info, data_json) VALUES (7, 1, 3, 'stat_list', 'Stats: List', '{"items":"__rows.stats", "button_label":"View All Stats", "title":"Stats"}');
INSERT INTO web_site_page_widget (id, web_site_page, web_widget, name, info, data_json) VALUES (8, 1, 4, 'chart_area_stats', 'Chart: Stats', '{"items":"__rows.stats", "title":"Chart of Stats"}');
INSERT INTO web_site_page_widget (id, web_site_page, web_widget, name, info, data_json) VALUES (9, 1, 5, 'chart_donut_stats', 'Chart: Stats', '{"items":"__rows.stats", "button_label":"View All Stats", "title":"Stats"}');
INSERT INTO web_site_page_widget (id, web_site_page, web_widget, name, info, data_json) VALUES (10, 1, 6, 'chart_bar_stats', 'Chart: Stats', '{"items":"__rows.stats", "button_label":"View All Stats", "title":"Stats"}');
INSERT INTO web_site_page_widget (id, web_site_page, web_widget, name, info, data_json) VALUES (11, 1, 7, 'chat_stats', 'Chat', '{"items":"__rows.stats", "button_label":"Send", "title":"Chat about Stats"}');
INSERT INTO web_site_page_widget (id, web_site_page, web_widget, name, info, data_json) VALUES (12, 1, 8, 'timeline_stats', 'Timeline: Stats', '{"items":"__rows.stats", "title":"Timeline of Stats"}');
INSERT INTO web_site_page_widget (id, web_site_page, web_widget, name, info, data_json) VALUES (13, 1, 9, 'dropdown_messages', 'Messages', '{"items":"__rows.stats", "button_label":"View All Messages", "icon":"envelope-o"}');
INSERT INTO web_site_page_widget (id, web_site_page, web_widget, name, info, data_json) VALUES (14, 1, 10, 'dropdown_tasks', 'Tasks', '{"items":"__rows.stats", "button_label":"View All Tasks", "icon":"key"}');
INSERT INTO web_site_page_widget (id, web_site_page, web_widget, name, info, data_json) VALUES (15, 1, 11, 'dropdown_comments', 'Comments', '{"items":"__rows.stats", "button_label":"View All Stats", "icon":"film"}');
INSERT INTO web_site_page_widget (id, web_site_page, web_widget, name, info, data_json) VALUES (16, 1, 12, 'navbar_side', 'Navbar Side', '{"items":"__rows.web_site_map_item"}');
INSERT INTO web_site_page_widget (id, web_site_page, web_widget, name, info, data_json) VALUES (17, 2, 13, 'data_json', 'RPC: Table: Results', '{"data_json":"__table_control.table.id"}');
