--
-- File generated with SQLiteStudio v3.0.7 on Fri Jan 15 16:11:25 2016
--
...
CREATE TABLE web_site_map_item (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, web_site_map INTEGER REFERENCES web_site_map (id) NOT NULL, name TEXT NOT NULL, priority INTEGER DEFAULT (0), parent INTEGER REFERENCES web_site_map_item (id));

-- Table: web_site_map
CREATE TABLE web_site_map (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name TEXT NOT NULL);
